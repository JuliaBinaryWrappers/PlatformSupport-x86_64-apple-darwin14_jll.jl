module PlatformSupport-x86_64-apple-darwin14_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PlatformSupport-x86_64-apple-darwin14_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("a0172053-b55b-5a6c-b1e8-7cdc15da24ae"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PlatformSupport-x86_64-apple-darwin14", artifacts_toml) for e in artifacts["PlatformSupport-x86_64-apple-darwin14"]]
...
if best_platform === nothing
    @debug("Unable to load PlatformSupport-x86_64-apple-darwin14; unsupported platform $(triplet(platform_key_abi()))")
else
    # Load the appropriate wrapper
    include(joinpath(@__DIR__, "wrappers", "$(best_platform).jl"))
end

end  # module PlatformSupport-x86_64-apple-darwin14_jll
